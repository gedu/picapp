...
public class FlickrClient extends BaseHttpClient {
    ...
    public void getPhotoList(String page, String query, CallbackResponse responseListener){
        ...
        doGet(String.format(FLICKR_SEARCH_URL, BuildConfig.FLICKR_API_KEY, PHOTO_PER_PAGE, page, queryParam, method), responseListener);
    }
